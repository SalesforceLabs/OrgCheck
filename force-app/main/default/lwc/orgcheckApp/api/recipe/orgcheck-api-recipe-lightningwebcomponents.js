...
export class OrgCheckRecipeLightningWebComponents extends OrgCheckRecipe {
     ...
     */
    extract(logger) {
        return [OrgCheckDatasetAliases.LIGHTNINGWEBCOMPONENTS];
    }
    ...
    async transform(data, logger, namespace) {
        ...
        // Get data
        const  /** @type {Map<string, SFDC_LightningWebComponent>} */ components = data.get(OrgCheckDatasetAliases.LIGHTNINGWEBCOMPONENTS);
