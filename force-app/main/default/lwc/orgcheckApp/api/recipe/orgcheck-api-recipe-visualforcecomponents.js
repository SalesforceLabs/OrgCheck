...
export class OrgCheckRecipeVisualForceComponents extends OrgCheckRecipe {
     ...
     */
    extract(logger) {
        return [OrgCheckDatasetAliases.VISUALFORCECOMPONENTS];
    }
    ...
    async transform(data, logger, namespace) {
        ...
        // Get data
        const /** @type {Map<string, SFDC_VisualForceComponent>} */ components = data.get(OrgCheckDatasetAliases.VISUALFORCECOMPONENTS);
