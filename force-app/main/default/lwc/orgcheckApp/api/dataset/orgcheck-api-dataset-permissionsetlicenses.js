...
export class OrgCheckDatasetPermissionSetLicenses extends OrgCheckDataset {
    ...
    async run(sfdcManager, dataFactory, logger) {
        ...
        const permissionSetLicenses = new Map(await OrgCheckProcessor.map(permissionSetLicenseRecords, (record) => {
            ...
            const permissionSetLicense = permissionSetLicenseDataFactory.create({
                properties: {
                    ...
                    url: sfdcManager.setupUrl(id, OrgCheckSalesforceMetadataTypes.PERMISSION_SET_LICENSE)
                }
            });
        ...
        await OrgCheckProcessor.forEach(assigneePermSetsWithLicenseRecords, (record) => {
        ...
        await OrgCheckProcessor.forEach(permissionSetsWithLicenseRecords, (record) => {
        ...
        await OrgCheckProcessor.forEach(permissionSetLicenses, (record) => {
