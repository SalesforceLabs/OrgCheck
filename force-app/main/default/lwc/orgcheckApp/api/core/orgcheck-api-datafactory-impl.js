...
export class OrgCheckDataFactory extends OrgCheckDataFactoryIntf {
    ...
    /**
     * @see OrgCheckDataFactoryIntf.getInstance
     * @param {any} dataClass 
     * @returns {OrgCheckDataFactoryInstanceIntf}
     */
    getInstance(dataClass) {
        const isDataWithScoring = IS_CLASS_EXTENDS(dataClass, OrgCheckData);
        const isDataWithDependencies = IS_CLASS_EXTENDS(dataClass, OrgCheckDataWithDependencies);
        const isDataWithoutScoring = IS_CLASS_EXTENDS(dataClass, OrgCheckDataWithoutScoring);
        // Checking dataClass
        if (isDataWithScoring === false && isDataWithoutScoring === false && isDataWithDependencies === false) {
            throw new TypeError('Given dataClass does not extends OrgCheckData nor OrgCheckDataWithDependencies nor OrgCheckDataWithoutScoring');
        }
 ...
 * @public
 */
export class OrgCheckDataFactoryInstance extends OrgCheckDataFactoryInstanceIntf {
    ...
    create(configuration) {
        ...
        if (this._isDependenciesNeeded === true && configuration.dependencies) {
            row.dependencies = OrgCheckDataDependenciesFactory.create(configuration.dependencies.data, row[configuration.dependencies.idField || 'id']);
        }
