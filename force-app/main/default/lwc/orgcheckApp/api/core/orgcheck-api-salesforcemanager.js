...
import { OrgCheckSalesforceUsageInformation } from './orgcheck-api-salesforce-watchdog';
import { SFDC_ApexClass } from '../data/orgcheck-api-data-apexclass';

/**
 * @description Salesforce Query request
 */
export class OrgCheckSalesforceQueryRequest {
 ...
 */ 
export class OrgCheckSalesforceMetadataRequest {
 ...
 */
export class OrgCheckSalesforceManagerIntf {
