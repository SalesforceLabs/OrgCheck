...
export default class OrgcheckApp extends LightningElement {
    ...
    _internalTransformers = {
        ...
        'record-types':              { label: 'Record Types',               tab: 'data-model',  isGlobalView: true,      data: 'recordTypesTableData',                    remove: () => { this._api?.removeAllRecordTypesFromCache(); },                getAlias: this._nt,   get: async () => { return this._api?.getRecordTypes(); }},
