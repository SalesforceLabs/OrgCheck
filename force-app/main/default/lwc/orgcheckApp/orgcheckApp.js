...
export default class OrgcheckApp extends LightningElement {
    ...
    _internalTransformers = {
        ...
        'field-permissions':         { label: '🚧 Field Level Securities',    isGlobalView: false,     data: '_internalFieldPermissionsDataMatrix',   remove: () => { this._api?.removeAllFieldPermissionsFromCache(); },         getAlias: this._on,   get: async () => { return this._api?.getFieldPermissions(this.object, this.namespace); }},
