import { OBJECTTYPE_ID_STANDARD_SOBJECT, OBJECTTYPE_ID_CUSTOM_SOBJECT, 
    ...
    OBJECTTYPE_ID_KNOWLEDGE_ARTICLE, OBJECTTYPE_ID_CUSTOM_BIG_OBJECT } from './orgcheck-api-data-objecttype';
...
export class OrgCheckSalesforceManager {
    ...
    mapFieldsFromSetup(setup, that, needScoring, retrieveDependenciesFromField) {
        if (setup) {
            ...
            if (setup.dependencies && retrieveDependenciesFromField) {
                ...
                that.dependencies = {
                    using: this.dapiWhatIsItUsing(setup.dependencies, id),
                    referenced: this.dapiWhereIsItUsed(setup.dependencies, id),
                    referencedByTypes: this.dapiHowManyTimesIsItUsedByType(setup.dependencies, id)
                }
            }
        }
    }
