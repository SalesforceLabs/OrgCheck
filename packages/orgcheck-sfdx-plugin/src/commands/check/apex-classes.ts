...
export default class CheckApexClasses extends SfCommand<OrgCheckSfPluginOutput<SfdcApexClass[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.apex-classes.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.apex-classes.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.apex-classes.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcApexClass[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('apex-classes', orgcheckApi, results);
  }
}