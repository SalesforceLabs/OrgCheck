...
export default class CheckVisualForceComponents extends SfCommand<OrgCheckSfPluginOutput<SfdcVisualForceComponent[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.visualforce-components.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.visualforce-components.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.visualforce-components.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcVisualForceComponent[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('visualforce-components', orgcheckApi, results);
  }
}