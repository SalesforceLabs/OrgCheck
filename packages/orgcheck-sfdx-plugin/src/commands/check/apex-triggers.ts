...
export default class CheckApexTriggers extends SfCommand<OrgCheckSfPluginOutput<SfdcApexTrigger[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.apex-triggers.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.apex-triggers.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.apex-triggers.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcApexTrigger[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('apex-triggers', orgcheckApi, results);
  }
}