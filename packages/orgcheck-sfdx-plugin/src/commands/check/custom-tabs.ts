...
export default class CheckCustomTabs extends SfCommand<OrgCheckSfPluginOutput<SfdcCustomTab[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.custom-tabs.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.custom-tabs.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.custom-tabs.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcCustomTab[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('custom-tabs', orgcheckApi, results);
  }
}