...
export default class CheckLightningPages extends SfCommand<OrgCheckSfPluginOutput<SfdcLightningPage[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.lightning-pages.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.lightning-pages.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.lightning-pages.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcLightningPage[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('lightning-pages', orgcheckApi, results);
  }
}