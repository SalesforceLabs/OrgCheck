...
export default class CheckApexTests extends SfCommand<OrgCheckSfPluginOutput<SfdcApexClass[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.apex-tests.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.apex-tests.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.apex-tests.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcApexClass[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('apex-tests', orgcheckApi, results);
  }
}