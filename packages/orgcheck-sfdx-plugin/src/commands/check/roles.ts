...
export default class CheckRoles extends SfCommand<OrgCheckSfPluginOutput<SfdcUserRole[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.user-roles.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.user-roles.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.user-roles.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcUserRole[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('user-roles', orgcheckApi, results);
  }
}