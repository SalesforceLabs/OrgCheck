...
export default class CheckDashboards extends SfCommand<OrgCheckSfPluginOutput<SfdcDashboard[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.dashboards.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.dashboards.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.dashboards.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcDashboard[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('dashboards', orgcheckApi, results);
  }
}