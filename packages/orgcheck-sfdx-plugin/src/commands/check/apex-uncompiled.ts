...
export default class CheckApexUncompiled extends SfCommand<OrgCheckOutput<SfdcApexClass[]>> {
  
  public static readonly summary = OrgCheckMessages.getMessage('check.apex-uncompiled.summary');
  public static readonly description = OrgCheckMessages.getMessage('check.apex-uncompiled.description');
  public static readonly examples = OrgCheckMessages.getMessages('check.apex-uncompiled.examples');
  ...
  public async run(): Promise<OrgCheckOutput<SfdcApexClass[]>> {
    ...
    return OrgCheckGenerateOutput('apex-uncompiled', flags, orgcheckApi, results);
  }
}