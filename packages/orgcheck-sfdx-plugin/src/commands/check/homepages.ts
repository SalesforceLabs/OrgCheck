...
export default class CheckHomePageComponents extends SfCommand<OrgCheckSfPluginOutput<SfdcHomePageComponent[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.homepages.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.homepages.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.homepages.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcHomePageComponent[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('homepages', orgcheckApi, results);
  }
}