...
export default class CheckEmailTemplates extends SfCommand<OrgCheckSfPluginOutput<SfdcEmailTemplate[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.email-templates.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.email-templates.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.email-templates.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcEmailTemplate[]>> {
