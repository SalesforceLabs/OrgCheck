...
export default class CheckRecordTypes extends SfCommand<OrgCheckSfPluginOutput<SfdcRecordType[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.record-types.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.record-types.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.record-types.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcRecordType[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('record-types', orgcheckApi, results);
  }
}