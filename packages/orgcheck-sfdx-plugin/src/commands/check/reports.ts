...
export default class CheckReports extends SfCommand<OrgCheckSfPluginOutput<SfdcReport[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.reports.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.reports.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.reports.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcReport[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('reports', orgcheckApi, results);
  }
}