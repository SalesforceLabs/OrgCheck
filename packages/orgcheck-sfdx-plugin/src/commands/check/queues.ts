...
export default class CheckQueues extends SfCommand<OrgCheckSfPluginOutput<SfdcGroup[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.queues.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.queues.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.queues.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcGroup[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('queues', orgcheckApi, results);
  }
}