...
export default class CheckLightningWebComponents extends SfCommand<OrgCheckSfPluginOutput<SfdcLightningWebComponent[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.lightning-web-components.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.lightning-web-components.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.lightning-web-components.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcLightningWebComponent[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('lightning-web-components', orgcheckApi, results);
  }
}