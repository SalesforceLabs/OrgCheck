...
export default class CheckKnowledgeArticles extends SfCommand<OrgCheckSfPluginOutput<SfdcKnowledgeArticle[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.knowledge-articles.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.knowledge-articles.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.knowledge-articles.examples');
