...
export default class CheckFlows extends SfCommand<OrgCheckSfPluginOutput<SfdcFlow[]>> {
  
  public static readonly summary = OrgCheckSfPluginMessages.getMessage('check.flows.summary');
  public static readonly description = OrgCheckSfPluginMessages.getMessage('check.flows.description');
  public static readonly examples = OrgCheckSfPluginMessages.getMessages('check.flows.examples');
  ...
  public async run(): Promise<OrgCheckSfPluginOutput<SfdcFlow[]>> {
    ...
    return OrgCheckSfPluginGenerateOutput('flows', orgcheckApi, results);
  }
}