...
export class RecipeObjectTypes implements Recipe<SfdcObjectType[]> {
     ...
     * @param {SimpleLoggerIntf} _logger - Logger
     * @returns {Promise<SfdcObjectType[]>} Returns as it is the value returned by the transform method recipe.
     * @async
     * @public
     */
    async transform(data: Map<string, any>, _logger: SimpleLoggerIntf): Promise<SfdcObjectType[]> {
