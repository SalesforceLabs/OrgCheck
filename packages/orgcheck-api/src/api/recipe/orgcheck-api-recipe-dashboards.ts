...
export class RecipeDashboards implements ServedRecipe<SfdcDashboard[], Table> {
     ...
     * @public
     */
    public readonly title: string = '🌲 Dashboards';
     ...
     * @param {SimpleLoggerIntf} _logger - Logger
     * @returns {Promise<SfdcDashboard[]>} Returns the mixture
     * @async
     * @public
     */
     ...
     * @param {SfdcDashboard[]} mixture - Mixed data to be served to a table
     * @returns {Promise<Table>} The processed view
     * @async
     * @public
     */
    public async serveToTable(mixture: SfdcDashboard[]): Promise<Table> {
        return TableFactory.create(this.title, new DashboardsTableDefinition(), mixture);
    }
