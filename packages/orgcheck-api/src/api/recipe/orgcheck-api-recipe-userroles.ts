...
export class RecipeUserRoles implements Recipe<SfdcUserRole[]> {
     ...
     * @param {SimpleLoggerIntf} _logger - Logger
     * @returns {Promise<SfdcUserRole[]>} Returns as it is the value returned by the transform method recipe.
     * @async
     * @public
     */
    async transform(data: Map<string, any>, _logger: SimpleLoggerIntf): Promise<SfdcUserRole[]> {

        // Get data
        const userRoles: Map<string, SfdcUserRole> = data.get(DatasetAliases.USERROLES);
