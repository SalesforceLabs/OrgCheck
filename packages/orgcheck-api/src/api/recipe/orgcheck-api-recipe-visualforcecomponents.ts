...
export class RecipeVisualForceComponents implements Recipe<SfdcVisualForceComponent[]> {
     ...
     * @returns {Promise<SfdcVisualForceComponent[]>} Returns as it is the value returned by the transform method recipe.
     * @async
     * @public
     */
    async transform(data: Map<string, any>, _logger: SimpleLoggerIntf, parameters: Map<string, any>): Promise<SfdcVisualForceComponent[]> {

        // Get data and parameters
        const components: Map<string, SfdcVisualForceComponent> = data.get(DatasetAliases.VISUALFORCECOMPONENTS);
