...
export class RecipeVisualForceComponents implements ServedRecipe<SfdcVisualForceComponent[], Table> {
     ...
     * @public
     */
    public readonly title: string = '🍞 Visualforce Components';
     ...
     * @returns {Promise<SfdcVisualForceComponent[]>} Returns the mixture
     * @async
     * @public
     */
    public async mix(ingredients: Map<string, any>, _logger: SimpleLoggerIntf, parameters: Map<string, any>): Promise<SfdcVisualForceComponent[]> {
        ...
        await MediumProcessor.forEach(components, async (component: SfdcVisualForceComponent) => {
     ...
     * @param {SfdcVisualForceComponent[]} mixture - Mixed data to be served to a table
     * @returns {Promise<Table>} The processed view
     * @async
     * @public
     */
    public async serveToTable(mixture: SfdcVisualForceComponent[]): Promise<Table> {
        return TableFactory.create(this.title, new VisualForceComponentsTableDefinition(), mixture);
    }
