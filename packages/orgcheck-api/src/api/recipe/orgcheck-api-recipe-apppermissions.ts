...
export class RecipeAppPermissions implements Recipe<DataMatrixIntf> {
    ...
    async transform(data: Map<string, any>, _logger: SimpleLoggerIntf, parameters: Map<string, any>): Promise<DataMatrixIntf> {
        ...
        const applications: Map<string, SfdcApplication> = data.get(DatasetAliases.APPLICATIONS);
        const appPermissions: Map<string, SfdcAppPermission> = data.get(DatasetAliases.APPPERMISSIONS);
