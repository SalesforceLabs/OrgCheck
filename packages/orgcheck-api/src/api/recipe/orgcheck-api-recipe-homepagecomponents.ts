...
export class RecipeHomePageComponents implements ServedRecipe<SfdcHomePageComponent[], Table> {
     ...
     * @public
     */
    public async mix(ingredients: Map<string, unknown>): Promise<SfdcHomePageComponent[]> {

        // Get data
        const pages = ingredients.get(DatasetAliases.HOMEPAGECOMPONENTS) as Map<string, SfdcHomePageComponent>;
