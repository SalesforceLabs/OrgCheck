...
export class RecipeCustomLabels implements ServedRecipe<SfdcCustomLabel[], Table> {
     ...
     * @public
     */
    public async mix(ingredients: Map<string, unknown>, _logger: SimpleLoggerIntf, parameters: Map<string, string>): Promise<SfdcCustomLabel[]> {

        // Get data and parameters
        const customLabels = ingredients.get(DatasetAliases.CUSTOMLABELS) as Map<string, SfdcCustomLabel>;
