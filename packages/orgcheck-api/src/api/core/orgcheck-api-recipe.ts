...
export interface Recipe {
     ...
     * @public
     */
    extract(logger: SimpleLoggerIntf, parameters: Map<string, any>): Array<string | DatasetRunInformation> | undefined;
     ...
     * @public
     */
    transform(data: Map<string, any>, logger: SimpleLoggerIntf, parameters: Map<string, any>): Promise<Array<Data | DataWithoutScoring> | DataMatrix | Data | DataWithoutScoring | Map<string, any>>;
}