...
export class Storage implements StorageIntf {
     ...
     */
    _storage: { setItem: Function; getItem: Function; removeItem: Function; key: Function; length: number; };
     ...
     */
    constructor(localStorage: { setItem: Function; getItem: Function; removeItem: Function; key: Function; length: number; }) {
