...
export class ObjectsTableDefinition implements TableDefinition {
    ...
    columns: TableColumn[] = [
        ...
        { label: 'Inactive Validation Rules', type: ColumnType.NUM, data: { value: 'nbInactiveValidationRules' }},
